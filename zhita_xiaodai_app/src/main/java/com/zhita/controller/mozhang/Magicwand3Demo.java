...
//        enhance(Magicwand3Constant.APP_ID, Magicwand3Constant.PRIVATE_Key);
    ...
    public static void enhance(String appId, String privateKey) throws Exception {
        /** 业务参数 */
...
//        bizParams.put("mobile", "13780132026");
        bizParams.put("name", "陈峥");
        bizParams.put("idcard", "330225199507155112");
        bizParams.put("mobile", "13486070402");
