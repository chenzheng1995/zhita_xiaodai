 ...
 */
public class OperatorInfoAction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		log("=====需要验证的身份证(id_card):" + id_card + " ,姓名(name)：" + name + " ,手机号(mobile):" + mobile+",手机基本信息类型(type)："+type);
		/** 1、 商户号 **/
		...
		String request_url = Config.getConstants().get("operatorAuthInfoUrl");
