...
//	}
	 ...
	 * @return
	 */
	public String sendSMS1 (String mobile,String format,String company,String sign) {
	    ...
	    Map<String, Object> map = JSON.parseObject(postAndGet.sendGet("http://106.ihuyi.com/webservice/sms.php?method=Submit&account="+APIID+"&password="+APIKEY+"&mobile="+mobile+"&content="+content+"&sign="+sign+"&format="+format));
